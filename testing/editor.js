...
const options = {
  method: 'POST',
  url: 'https://us1.pdfgeneratorapi.com/api/v4/templates/569200/editor',
  headers: {
  ...
  body: {
    data: {text: "Dear Ma'am <br/> <br/> Testing testing from api for the editor <br/> <br/> Love,  <br/> <br/> Dan ", image: image, qrcode: 'https://google.com'},
    language: 'en'
  },
  json: true
};
...
// plan
// 1. use the template id (which is per L-R page spread) to create a new doc (pdf url stored in S3) for each contributor (ROUTE --> when contributor clicks Submit)
